      ...
      <div className='grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12'>
        ...
        <div className='grid-default-color grid-5'>
          <div className='z-10 w-[50%]'>
            ...
            <p className='subtext'>I'm working hard and getting comfortable with a variety of frameworks and libraries to build reliable, scalable applications. I'm excited by my progress!</p>
          </div>
